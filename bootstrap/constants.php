...
if (empty($_SERVER['DOCUMENT_ROOT'])) {
    $_SERVER['DOCUMENT_ROOT'] = dirname(__DIR__) . DS . 'public';
}
...
if (!defined('PRODUCTION_DOMAIN')) {
    define('PRODUCTION_DOMAIN', 'testAssignmentLaravel.localhost.com');
}

if (!defined('STAGING_DOMAIN')) {
    define('STAGING_DOMAIN', 'testAssignmentLaravel.localhost.com');
}

if (!defined('LOCAL_DOMAIN')) {
    define('LOCAL_DOMAIN', 'testAssignmentLaravel.localhost.com');
}
...
if (!defined('DOMAIN')) {
    define('DOMAIN', (ENVIRONMENT == 'local' ? 'testAssignmentLaravel.localhost.com' : 'testAssignmentLaravel.localhost.com'));
}
